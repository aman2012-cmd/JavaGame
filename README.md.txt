...
Go to src folder → Right click → New → Package → name it com.brainmentors.gaming

Create subpackage com.brainmentors.gaming.sprites

Copy the Java files into the appropriate packages

Add all image files (.jpeg, .gif) to the resources folder inside the project

Right-click the project → Build Path → Configure Build Path

Under Source, add the resources folder as a resource folder

Run GameFrame.java as a Java Application
...
This project is licensed under the MIT License.on